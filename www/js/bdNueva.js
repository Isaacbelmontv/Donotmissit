    ...
    transaction.oncomplete = function(event) {
        ...
        var handleResult = function(event) {
          ...
          if (cursor) {
            ...
            content += "<td><a class=\"btnuno btn-primary edit\"><i class=\"fa fa-pencil fa-2x\" aria-hidden=\"true\"></i></a></td>";
            content +=  "<td><a class=\"btndos btn-danger delete\"><i class=\"fa fa-trash-o fa-2x\" aria-hidden=\"true\"></i></a></td>";
/*ejemplo con clases*/
